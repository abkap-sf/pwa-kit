...
module.exports = {
    app: {
        ...
        commerceAgenticEsdName:
            process.env.COMMERCE_AGENTIC_EMBEDDED_SERVICE_DEVELOPER_NAME ||
            'Dummy Embedded Service Deployment Name',
        commerceAgenticEsdEndpoint:
            process.env.COMMERCE_AGENTIC_EMBEDDED_SERVICE_FULL_ENDPOINT ||
            'Dummy Embedded Service Deployment Endpoint',
        commerceAgenticEsdScriptSourceUrl:
            process.env.COMMERCE_AGENTIC_EMBEDDED_SERVICE_SCRIPT_SOURCE_URL ||
            'https://dummysourceurl.com',
